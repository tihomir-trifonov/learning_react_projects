...
const getVisibleExpenses = (expenses, {text, sortBy, startDate, endDate}) => {
    return expenses.filter(
        (expense)=>{
            ...
            const textMatch = typeof text === "string" ? expense.description.toLowerCase().includes(text.toLowerCase()):false;
...
const expenseOne = store.dispatch(addExpense({ description: "rent", amount: 23, createdAt: -1000 }))
